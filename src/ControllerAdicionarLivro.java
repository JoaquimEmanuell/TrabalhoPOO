...
public class ControllerAdicionarLivro implements Initializable
{
     private Parent root;
     private Stage stage;
     private Scene scene;
     ...
     public void initialize(URL arg0, ResourceBundle arg1) {
          ...
          tipoCheck.getItems().addAll(tipo);
     }
     ...
     public void adiconar(ActionEvent e)
     {
          ...
          File teste = new File("/home/joaqm_/Documentos/TrabalhoFinal/Livros/" + id + ".json");
          if(teste.exists())
          {
               Alert dialogoAviso = new Alert(Alert.AlertType.WARNING);
               dialogoAviso.setHeaderText("Atencao");
               dialogoAviso.setContentText("O ID que voce escolheu ja esta sendo usado, por favor escolha outro");
               dialogoAviso.showAndWait();
               return;
          }
          ...
          objeto.put("comentarios", comentarios);

          FileWriter file;
          try {
               file = new FileWriter("/home/joaqm_/Documentos/TrabalhoFinal/Livros/" + id + ".json");
